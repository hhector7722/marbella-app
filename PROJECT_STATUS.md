...
- [x] **Persistencia de Cantidades en Arqueos**: Corrección de parseo de JSON numérico (string a float) para que los modales de "Arqueo" (Caja Inicial, Cambio 1, Cambio 2) carguen y muestren por defecto el desglose actual en caja, permitiendo editar desde el estado real en lugar de partir de 0.

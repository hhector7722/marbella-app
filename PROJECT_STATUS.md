...
- [x] 🍱 **Alineación de Pedidos con Gallery-View**: Unificación total de la vista de pedidos con la galería de recetas. Implementado grid de `gap-6`, tarjetas `rounded-2xl`, fuentes de `10px` y zona de controles esbelta (`py-1.5`) para una experiencia visual Marbella Premium 100% consistente.

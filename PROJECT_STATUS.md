...
- [x] **Control Ágil "Bolsa vs Pago" (Weekly Override)**: Implementación de sistema de override semanal para la preferencia de horas extras (`prefer_stock_hours`). Permite a los managers decidir, semana a semana y trabajador a trabajador, si las horas se envían a la bolsa (Bolsa de Horas) o se pagan en nómina (Pago en Nómina), con recálculo y propagación automática de balances globales.

...
**Fuente**: `PROJECT_STATUS.md` — **última actualización:** 2026-06-04 (Albaranes: precio sin pisar unidades del ingrediente)
...
- **Staff nav inferior: Pedidos + sin Propinas (2026-06-03)**: [`src/app/staff/layout.tsx`](src/app/staff/layout.tsx) — ítem **Pedidos** (`Package`, `/orders/new`, abre `SupplierSelectionModal` como `BottomNavStaff`); **Propinas** quitado de la barra (acceso solo desde [`StaffDashboardView`](src/components/dashboards/StaffDashboardView.tsx)).

...
**Una pantalla de trabajo cabe en un viewport.** Si la tarea principal exige desplazarse para verse completa, la pantalla está mal compuesta. Los modales de día caben en el viewport: el alto extra se reparte; las filas no bajan de lo legible. El calendario mensual parte del tamaño de Cierres y una semana crece si su contenido lo pide.
...
- El backdrop pertenece a la capa Modal: base con blur/saturate acotados; capas superiores solo oscurecen ([ADR-0008](../4-decisiones/ADR-0008-modal-backdrop-capas.md)). Prohibido acumular blur en el fondo.
- Cuando hay una superficie `derived` o `system` encima, el **panel** del Modal cubierto pasa a subordinado (blur, opacidad reducida, sin pointer events); la cima permanece dominante ([ADR-0009](../4-decisiones/ADR-0009-modal-subordinacion.md)).

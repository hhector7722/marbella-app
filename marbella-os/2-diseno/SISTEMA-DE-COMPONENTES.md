...
**Anatomía**: 4 columnas × 6 filas. La pista es el squircle del icono. El nombre (atajo o widget) vive en el hueco entre filas, no dentro de la pista. Un 2×2 iguala dos iconos + el gap del medio. La home Master ocupa una séptima fila: el mosaico es 4×7 en Master.

...
Los dos flotantes miden lo mismo y viven en un **dock vertical pegado al canto derecho**, **fuera del modal**. No son cromo de Modal: son iconos auxiliares de viewport. La calculadora va **encima** del desglose cuando coinciden. El dock es **arrastrable por toda la altura** de la pantalla y la posición elegida se recuerda por dispositivo. Por defecto se sienta sobre la **TabBar**, con el aire de `espacio.2`; si la cápsula está oculta o no hay TabBar, baja al área segura. **Nunca la tapa**: el arrastre se topa en ese canto inferior. Dentro de ese límite, la posición la fija el usuario; el sistema no la fuerza. El overlay cede `--quick-fab-lift` (canto inferior del dock) y reserva su ancho con `--quick-fab-dock` mientras los iconos están visibles. Con el panel abierto, el dock se retira: no se ve y no tapa teclas ni rejilla. Un chevron sutil (V) en el canto superior, de 48 px de toque, minimiza el panel y los devuelve.

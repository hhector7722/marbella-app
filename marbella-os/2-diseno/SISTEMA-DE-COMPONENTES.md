...
Los dos flotantes miden lo mismo y viven en **una sola fila** al canto inferior de la pantalla visible, centrados en el ancho, **fuera del modal**. No son cromo de Modal: son iconos auxiliares de viewport. La posición la fija el sistema; ninguna instancia los sube ni los pega a un lado. El overlay cede `--quick-fab-dock` mientras los iconos están visibles. Con el panel abierto, los flotantes quedan detrás: no se ven y no tapan teclas ni rejilla. Un chevron sutil (V) en el canto superior, de 48 px de toque, minimiza el panel y los devuelve.

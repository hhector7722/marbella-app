...
Los dos flotantes miden lo mismo y viven en **una sola fila** al canto inferior de la pantalla visible, centrados en el ancho, **fuera del modal**. No son cromo de Modal: son iconos auxiliares de viewport. **No tapan la TabBar.** Si la cápsula está visible, se sientan encima con el aire de `espacio.2`; si está oculta o no hay TabBar, bajan al canto (con el área segura). La posición la fija el sistema; ninguna instancia los sube ni los pega a un lado. El overlay cede `--quick-fab-dock` y `--quick-fab-lift` mientras los iconos están visibles (`--quick-fab-clearance` es ese lift, a cero si no hay iconos). Con el panel abierto, los flotantes quedan detrás: no se ven y no tapan teclas ni rejilla. Un chevron sutil (V) en el canto superior, de 48 px de toque, minimiza el panel y los devuelve.

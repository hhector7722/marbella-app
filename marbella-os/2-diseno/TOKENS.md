...
| `color.superficie.hundida` | `#FAFAFA` | Fondo de zonas agrupadas dentro de una superficie | adoptado (piloto fila de plantilla en Asistencia vía `--color-superficie-hundida`) |

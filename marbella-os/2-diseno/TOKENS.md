...
| `espacio.2` | 8 px | Separación interna mínima |
| `espacio.3` | 12 px | Relleno de controles compactos |
| `espacio.4` | 16 px | Relleno estándar de tarjeta, separación entre bloques |

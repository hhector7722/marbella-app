-- =================================================================
-- FIX: Que "guardar horas" (bolsa) por semana se respete en get_weekly_worker_stats
-- 1) Asegura que exista la columna prefer_stock_hours_override.
-- 2) Actualiza la RPC para usar COALESCE(s.prefer_stock_hours_override, p.prefer_stock_hours, false).
-- Ejecutar en Supabase SQL Editor.
-- =================================================================

-- 1. Columna en weekly_snapshots (si no existe)
ALTER TABLE public.weekly_snapshots
ADD COLUMN IF NOT EXISTS prefer_stock_hours_override boolean DEFAULT NULL;

-- 2. RPC actualizada (semana completa + override semanal)

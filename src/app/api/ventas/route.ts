...
// The instantiation must bypass missing env vars during the Next.js static build phase.
const getClient = () => createClient(
    process.env.NEXT_PUBLIC_SUPABASE_URL || 'mock-url',
    process.env.SUPABASE_SERVICE_ROLE_KEY || 'mock-key' // USA ESTA PARA BYPASS DE RLS
);

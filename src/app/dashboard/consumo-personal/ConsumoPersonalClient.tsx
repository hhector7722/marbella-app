...
export default function ConsumoPersonalClient() {
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-4 pb-8 text-mds-foreground month-cal-shell">
      <PageHeader
        title="Consumo staff"
        description="Importe y días de consumo del personal"
        actions={
          <PageActions>
            {canEditConsumptionOrder ? (
              ...
              >
                <ListOrdered size={20} strokeWidth={2.25} aria-hidden />
              </Button>
            ) : null}
            <TimeFilterButton
              ...
              buttonClassName={cn(
                'min-h-12 border border-mds-border bg-mds-muted-surface text-mds-foreground',
                'hover:bg-mds-muted-surface/80'
              )}
            />
            <div className="relative shrink-0 flex items-center justify-center">
              ...
              >
                <User size={20} strokeWidth={2.25} aria-hidden />
              </Button>
              {workerFilterId ? (
                <button
                  type="button"
                  ...
                  className="absolute -right-0.5 top-0.5 z-10 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-red-600 text-white shadow-sm ring-2 ring-mds-surface"
      ...
      <Surface className="relative overflow-hidden flex flex-col month-cal-card w-full p-0 shadow-sm">
            ...
            <div className="flex justify-center w-full">
              <div className="inline-flex items-center justify-center gap-1 sm:gap-2 max-w-full">
                <button
                  ...
                  className="shrink-0 p-2 rounded-xl hover:bg-mds-muted-surface transition-colors min-h-[48px] min-w-[48px] flex items-center justify-center text-mds-primary"
                  aria-label="Mes anterior"
                >
                  <ChevronLeft size={22} />
                </button>
                <span className="text-base md:text-lg font-black text-mds-primary capitalize text-center px-1 sm:px-2 min-w-0 max-w-[min(100%,14rem)] sm:max-w-none">
      ...
      {detailOpen &&
        ...
        createPortal(
          ...
          >
            ...
            >
              <div className="bg-mds-primary px-4 py-2 text-white shrink-0 flex items-center justify-between gap-1">
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar p-4 flex flex-col min-h-0">
                {detailLoading ? (
                  <div className="flex justify-center py-12">
                    <LoadingSpinner className="text-mds-primary" />
                  </div>
                ) : detailError ? (
                  <div className="flex flex-col items-center justify-center text-center gap-3 py-10">
                    ...
                    <div className="flex items-center gap-2 pt-2">
                      <button
                        ...
                        className="min-h-[48px] px-4 rounded-xl bg-mds-primary text-white font-black uppercase tracking-wider shadow-sm hover:opacity-95 active:scale-[0.99]"
                      >
                        Reintentar
                      </button>
                      <button
                  ...
                  <>
                    <div className="mb-4 rounded-[1.25rem] bg-mds-primary p-3 shadow-md">

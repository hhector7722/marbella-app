...
import ConsumoPersonalClient from './ConsumoPersonalClient'

export const dynamic = 'force-dynamic'

const BREADCRUMBS: BreadcrumbItem[] = [
  { id: 'dashboard', label: 'Dashboard', href: '/dashboard' },
  { id: 'consumo-personal', label: 'Consumo staff' },
]
...
/**
 * Consumo del personal (fichaje / recetas de consumo).
 * Gate manager/admin — igual que legacy en cliente.
 * Slice XI Personal: independiente del Hours Engine.
 */
export default async function ConsumoPersonalPage() {

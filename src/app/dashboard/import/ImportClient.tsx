...
export default function ImportClient() {
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-8 pb-8 text-mds-foreground">
            <PageHeader
                title="Asistente de Migración Legacy"
                description="Importa tus datos históricos paso a paso asegurando la integridad de la base de datos."
            />
                    ...
                    return (
                        <div
                            ...
                            className={cn(
                                ...
                                isActive ? "border-mds-primary bg-mds-primary/5" : "border-zinc-200 bg-white",
                                isPast ? "opacity-60" : ""
                            )}
                        >
                            <div className={cn(
                                "w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm mb-2",
                                isActive ? "bg-mds-primary text-mds-primary-foreground" : "bg-zinc-100 text-zinc-500"
                            )}>
                                {index + 1}
                            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            {currentStep === 'recipes' && (
                                <div className="space-y-2 text-xs">
                                    ...
                                    <Link
                                        ...
                                        className="inline-flex min-h-12 items-center justify-center w-full rounded-lg bg-mds-primary/10 text-mds-primary font-semibold px-3 hover:bg-mds-primary/15"
                                    >
                ...
                <div className="md:col-span-2 space-y-6">
                    {/* Main Card */}
                    <div className="rounded-xl border bg-card text-card-foreground shadow-sm border-dashed border-2 shadow-none min-h-[300px] flex flex-col justify-center items-center relative overflow-hidden transition-all hover:border-mds-primary/50">
                        {fileData.length === 0 ? (
                                ...
                                <div className="p-4 border-t bg-zinc-50/30 flex justify-end gap-3 rounded-b-xl">
                                    {!importResult?.success ? (
                                        <button
                                            ...
                                            className="inline-flex min-h-12 items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mds-primary/30 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-mds-primary text-mds-primary-foreground hover:bg-mds-primary/90 px-4 py-2"
                                        >
                                            {isUploading ? (
                                                <>

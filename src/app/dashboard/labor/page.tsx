                ...
                <div className="bg-white rounded-[2.5rem] shadow-2xl relative overflow-hidden flex flex-col min-h-[80vh]">
                    ...
                    <div className="bg-[#36606F] p-8 pb-10 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <h1 className="text-3xl font-black tracking-tighter mb-1 uppercase">Coste Laboral</h1>
                            <p className="text-[10px] text-white/50 font-black uppercase tracking-[0.3em] italic">Análisis de Eficiencia</p>
                        </div>

  ...
  <body>
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-4 pb-8 text-mds-foreground">
            <PageHeader
                title="Movimientos"
                description="Caja operativa · libro, entradas, salidas y arqueo"
            />

            {/* TARJETA GLOBAL INTEGRADA (TODO EN UN BLOQUE) */}
            <Surface className="overflow-hidden p-0 shadow-sm">

                    {/* CABECERA COMPACTA (toolbar operativa) */}
                    <div className="bg-mds-primary px-1.5 py-1 md:px-2 md:py-1.5 relative shrink-0">
                    ...
                    <div className="bg-white">
                        ...
                        <div className="py-4 px-2 grid grid-cols-4 border-b border-zinc-50">
                            ...
                            <div className="flex flex-col items-center justify-center text-center border-l border-zinc-100 px-1">
                                <span className="text-[13px] md:text-2xl font-black text-mds-primary line-clamp-1 tabular-nums">
                                    {latestLedgerLoading ? (
                                        " "

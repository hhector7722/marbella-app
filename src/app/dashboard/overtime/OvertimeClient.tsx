...
import { PageActions, PageHeader, Surface } from '@/components/mds';
...
const StaffOvertimeRow = memo(({
    ...
    <div onClick={onClick} className="flex items-center justify-between p-3 bg-white/60 rounded-2xl border border-mds-border/40 cursor-pointer hover:bg-white transition-colors group">
        <span className="text-xs font-bold text-gray-700 capitalize group-hover:text-mds-primary transition-colors leading-none">
            {staff.name}
        </span>
    ...
    return (
        <>
            <div className="mx-auto max-w-4xl space-y-4 pb-8 text-mds-foreground">
                <PageHeader
                    title="Horas extras"
                    description="Semanas cerradas, pagos y bolsa de horas"
                    actions={
                        <PageActions>
                            <TimeFilterButton
                ...
                <Surface className="overflow-hidden flex flex-col w-full p-0 shadow-sm">
                        ...
                        <div className="p-4 md:p-6 flex flex-col shrink-0">
                            ...
                            <div className="flex items-center justify-center gap-2 mb-3 md:mb-4">
                                <button
                                    ...
                                    className="p-2 rounded-xl hover:bg-mds-muted-surface text-zinc-600 hover:text-mds-primary transition-colors shrink-0 min-h-[48px] min-w-[48px] flex items-center justify-center"
                                ...
                                <button
                                    type="button"
                                    onClick={() => setIsTimeFilterOpen(true)}
                                    className="text-sm md:text-base font-black uppercase tracking-wider text-mds-primary min-w-[140px] text-center hover:opacity-80 transition-colors py-2"
                                >
                            ...
                            {loading ? (
                                <div className="flex items-center justify-center py-12">
                                    <div className="w-10 h-10 border-2 border-mds-primary border-t-transparent rounded-full animate-spin" />
                                </div>
                            ) : (
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        'bg-transparent border-0 hover:bg-mds-muted-surface/50'
                                                    )}
                                                >
                ...
                return (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setWeekDetailModal(null)}>
                        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[85vh] flex flex-col overflow-hidden" onClick={e => e.stopPropagation()}>
                            <div className="bg-mds-primary px-4 py-3 flex items-center justify-between gap-3 shrink-0">

...
<html>
  ...
  <body>
    ...
    return (
        <div className="mx-auto max-w-5xl space-y-4 pb-8 text-mds-foreground print:max-w-none print:pb-0">
            <PageHeader
                title="Ventas"
                description="Tickets, productos y tramos horarios"
                className="print:hidden"
            />

            <Surface className="overflow-hidden p-0 shadow-sm print:rounded-none print:shadow-none print:border-0">

                    {/* CABECERA Y FILTROS */}
                    <div className="bg-mds-primary p-1.5 md:p-3 relative shrink-0 print:hidden">
                        <div className="relative flex items-center justify-between gap-1 min-w-0">
                            <div className="flex items-center gap-1.5 md:gap-2 shrink-0 min-w-0">
                                <span className="text-xs md:text-sm font-black text-mds-primary-foreground uppercase tracking-tight italic text-nowrap shrink-0">Periodo</span>
                            </div>
                            ...
                            <div className="flex items-center gap-0.5 md:gap-1 shrink-0 min-w-0 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                                <button
                                    ...
                                    className="p-1 hover:bg-white/10 rounded-lg text-mds-primary-foreground transition-all outline-none shrink-0 min-h-12 min-w-10 flex items-center justify-center"
                                    aria-label="Anterior"
                                >
                                    <ChevronLeft size={16} />
                                </button>
                                <button
                                    ...
                                    className="py-0.5 px-1 text-[9px] sm:text-[10px] md:text-[11px] font-black text-mds-primary-foreground uppercase tracking-widest text-center outline-none max-w-[min(calc(100vw-5.5rem),24rem)] leading-tight"
                                >
                                    {filterMode === 'single'
                            ...
                            <div className="flex items-center gap-1 shrink-0 text-mds-primary-foreground">
                                {canAccessInsights ? (
                                    <button
                                        type="button"
                                        ...
                                        className={cn(
                                            ...
                                            'text-mds-primary-foreground/90 hover:text-mds-primary-foreground',
                    ...
                    <div className="pt-4 md:pt-5 pb-1 md:pb-1.5 px-4 grid grid-cols-3 border-b border-zinc-50 print:hidden">
                        ...
                        <div className="flex flex-col items-center justify-center text-center border-l border-zinc-100 italic">
                            <span className="text-lg md:text-2xl font-black tabular-nums leading-none text-mds-primary">
                    ...
                    {(() => {
                        ...
                        return (
                            <div className="w-full pb-1 pt-2 px-4 border-b border-zinc-50 shrink-0 print:hidden">
                                ...
                                <div className="flex justify-between px-0 text-[9px] font-mono text-mds-primary leading-none select-none pointer-events-none mt-0.5">
                                    <span>7h</span>
                                    <span>23h</span>
                                </div>
                                {selectedChartHour !== null && typeof document !== 'undefined' && (() => {
                                    ...
                                    const tooltipEl = (
                                        <div className="fixed z-[100] pointer-events-none" style={{ left: pointLeft, top: pointTop, transform: 'translate(-50%, -100%)', marginTop: '-4px' }}>
                                            ...
                                            <div className="absolute left-1/2 top-full w-3 h-3 rounded-full bg-mds-primary border-2 border-white shadow-sm -translate-x-1/2 -translate-y-1/2" />
                                        </div>
                                    );
                                ...
                                tickets.length === 0 ? (
                                    ...
                                    <div className="w-full bg-white rounded-2xl shadow-sm border border-zinc-200 overflow-hidden print-table-ventas">
                                        <table className="w-full text-left border-collapse">
                                            <thead className="bg-mds-primary text-white text-[9px] md:text-[10px] font-black uppercase tracking-wider md:tracking-[0.15em] border-b border-mds-primary">
                                                <tr>
                                            ...
                                            <div className="flex items-center justify-between gap-2 px-3 md:px-6 py-3 border-t border-zinc-100 print:hidden shrink-0">
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        pageOffset <= 0 ? "bg-zinc-100 text-zinc-300" : "bg-white text-mds-primary hover:bg-zinc-50 border border-zinc-200"
                                                    )}
                                                >
                                                    Anterior
                                                </button>
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        (pageOffset + pageSize) >= summary.count
                                                            ...
                                                            : "bg-white text-mds-primary hover:bg-zinc-50 border border-zinc-200"
                                                    )}
                                                >
                                                    Siguiente
                                                </button>

...
export default async function WebAnalyticsPage({ searchParams }: WebAnalyticsPageProps) {
  ...
  return (
    <Suspense fallback={null}>
      <DayPeriodChromeProvider day={filters.day} basePath="/dashboard/web" instance="web-period-filter">
        <DashboardDetailLayout
          ...
          periodSlot={<DayPeriodNav day={filters.day} basePath="/dashboard/web" />}
          rightSlot={
            <div className="flex shrink-0 items-center gap-1">
              ...
              <Link
                ...
                className="flex min-h-12 shrink-0 items-center px-2 text-xs font-semibold text-ds-texto"
              >
                Abrir web
              </Link>
            </div>

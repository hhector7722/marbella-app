...
export default function NewOrderPage() {
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#8FAFC4] to-[#7FA1B8]">
    ...
    return (
        <div className="w-full bg-gradient-to-br from-[#8FAFC4] to-[#7FA1B8] min-h-screen p-4 md:p-6 pb-24">

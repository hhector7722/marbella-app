...
export function SandboxView({
    ...
    if (hasRealSandboxPage(route)) return <RealAppView recipeOverride={recipeOverride} overrides={overrides ?? estetica?.overrides ?? {}} fontFamily={fontFamily ?? estetica?.fontFamily} />;

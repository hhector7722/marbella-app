...
function ProfileContent() {
    ...
    if (loading) {
        return <div className="min-h-screen bg-[#5F7F99]" />;
    }

    if (!profile) {
        return (
            <div className="min-h-screen bg-[#5F7F99] flex items-center justify-center p-6">
                <div className="bg-white rounded-[2.5rem] p-10 text-center shadow-2xl max-w-sm w-full">
                    ...
                    <button onClick={() => router.back()} className="mt-6 w-full py-4 bg-[#5F7F99] text-white rounded-2xl font-black uppercase text-xs tracking-widest">Volver</button>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#5F7F99] pb-24 p-4">
...
export default function StaffProfilePage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-[#5F7F99]" />}>
            <ProfileContent />
        </Suspense>
    );
}

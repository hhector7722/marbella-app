...
import { Alert, LoadingBlock } from '@/components/mds';
...
export default function GestionClient() {
  ...
  if (loading) {
    return (
      <div className="py-10">
        <LoadingBlock className="mx-auto w-full max-w-md" />
      </div>
    );
  }
  if (error) {
    return <Alert tone="danger" title="Error" description={error} />;
  }
    ...
    <div className="max-w-4xl space-y-4">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <select
          ...
          className="bg-white border border-gray-200 text-slate-700 text-sm px-3 py-2 rounded-lg outline-none focus:ring-2 focus:ring-mds-primary/50 shadow-sm cursor-pointer"
        >
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm w-full overflow-x-auto">
        <table className="w-full text-left text-sm text-slate-700 min-w-[320px]">
          <thead className="bg-mds-primary text-[10px] sm:text-xs uppercase font-semibold text-white/90">
            <tr>
              ...
              >
                <td className="px-2 sm:px-3 py-2 sm:py-3">
                  <input
                    ...
                    className="w-4 h-4 rounded accent-mds-primary cursor-pointer"
                  />
                </td>
            ...
            <div className="p-4 md:p-5 space-y-2">
              {[...selected].map(id => {
                ...
                return (
                  <label
                    key={id}
                    className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer border-2 transition-all ${survivorId === id ? 'border-mds-primary bg-mds-primary/5' : 'border-gray-200 hover:border-gray-300'}`}
                  >
                    <input
                      type="radio"
                      name="survivor"
                    ...
                    {survivorId === id && (
                      <span className="ml-auto text-[10px] font-bold text-mds-primary uppercase">Conservar</span>
                    )}
                  </label>
                );
              })}
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden flex flex-col">
            ...
            <div className="p-4 md:p-5 space-y-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl border border-gray-200 focus:outline-none focus:border-mds-primary focus:ring-1 focus:ring-mds-primary text-sm text-slate-700"
                />
              </div>
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl text-sm font-bold text-white bg-mds-primary hover:bg-mds-primary/90 shadow-md transition-colors"
              >
                Guardar
              </button>
            </div>

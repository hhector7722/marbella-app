    ...
    <Modal
      ...
      headerTrailing={
        <button
          ...
          className="relative flex h-full max-h-full min-h-0 shrink-0 items-center gap-1 px-1.5 text-[10px] font-black uppercase tracking-widest text-zinc-700 hover:opacity-75 disabled:opacity-50 transition-colors before:absolute before:inset-0 before:-m-[6px] before:min-h-12 before:min-w-12 before:content-['']"
        >
          {plusPedidoBusy ? (

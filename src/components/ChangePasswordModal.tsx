...
export default function ChangePasswordModal({
    ...
    return (
        <div data-marbella-modal-root className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div

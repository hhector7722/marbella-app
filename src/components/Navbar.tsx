...
import { CameraOnlineDot } from '@/components/CameraOnlineDot';
...
const CAMERA_STATUS_EMAIL = 'hhector7722@gmail.com';
...
export default function Navbar() {
    ...
    const canSeeCameraStatus = Boolean(sessionReady && !identity?.isViewingAs && userData?.email === CAMERA_STATUS_EMAIL);

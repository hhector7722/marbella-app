...
export default function Navbar() {
    ...
    return (
        <nav className="bg-[#5B8FB9] text-white pt-safe fixed top-0 left-0 right-0 z-40 border-b border-white/10 backdrop-blur-md shadow-sm h-header-safe flex items-center">

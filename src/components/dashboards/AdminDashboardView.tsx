    ...
    return (
        <div className="pt-0 md:pt-1 animate-in fade-in duration-500">
            <div className="px-3 md:p-6 w-full max-w-6xl mx-auto space-y-4 md:space-y-6 md:mt-0">
                {/* DESKTOP: Layout Compacto | MOBILE: stacking vertical */}
                <div className="hidden md:grid md:grid-cols-2 gap-3 md:gap-4 items-start">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white rounded-2xl shadow-xl flex flex-col overflow-hidden">
                            <div className="bg-[#36606F] px-4 py-2 md:py-3 flex justify-between items-center text-white shrink-0 relative">
                                <div className="flex items-center gap-2"><div><h3 className="text-sm md:text-base font-black uppercase tracking-wider leading-none">Ventas</h3></div></div>
                                <div className="absolute left-1/2 -translate-x-1/2 scale-100 md:scale-125"><LiveClock /></div>
                                <div className="flex items-center gap-3"><Link href="/dashboard/history" className="text-[10px] md:text-xs font-black pointer-events-auto hover:text-white/80 transition-colors uppercase tracking-widest">Ver más</Link></div>
                            </div>
                    ...
                    {/* Desktop Col 2: Cajas + Iconos (Paralelo) */}
                    <div className="space-y-3 md:space-y-4">
                        <div className="bg-white rounded-2xl p-2 md:p-3 shadow-xl flex flex-col">
                        ...
                        <div className="w-full grid grid-cols-12 gap-3 md:gap-4 pb-2">
                            {/* 4. CAJAS CAMBIO */}

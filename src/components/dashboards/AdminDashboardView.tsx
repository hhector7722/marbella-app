                                                                                    ...
                                                                                    {ticketLines.map((line, lIdx) => {
                                                                                        ...
                                                                                        return (
                                                                                            <tr key={lIdx} className="border-b border-zinc-100/50 last:border-0">
                                                                                                <td className="py-1.5 px-1 text-center tabular-nums text-zinc-400">
                                                                                                    {showUnits && line.unidades !== 0 ? line.unidades : ' '}
                                                                                                </td>
                                                                                                <td className={cn(
                                                                                                    "py-1.5 px-1 md:px-2 text-zinc-700 min-w-0 truncate",
                                                                                                    isSubItem && "pl-4 text-zinc-500 font-medium"
                                                                                                )}>

...
export default function KDSView() {
    ...
    return (
        <div className={`fixed inset-0 z-[100] flex flex-col bg-slate-900 transition-all duration-500 ${isOffline ? 'grayscale-[0.5]' : ''}`}>
            ...
            {/* Mantenemos los estilos del scrollbar intactos */}
            <style jsx global>{`

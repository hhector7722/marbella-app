...
export function KdsMesaNumber({ value, isCompleted }: KdsMesaNumberProps) {
    return (
        ...
        >
            ...
            <span
                className="pointer-events-none col-start-1 row-start-1 select-none text-center text-6xl text-transparent [-webkit-text-stroke:10px_rgb(255_255_255)] [paint-order:stroke_fill] [grid-area:mesa] sm:text-7xl sm:[-webkit-text-stroke:12px_rgb(255_255_255)] md:text-8xl md:[-webkit-text-stroke:13px_rgb(255_255_255)]"
                aria-hidden
            >
                {value}
            </span>

                                    ...
                                    return (
                                        <div key={inv.id} className="rounded-xl border border-zinc-200 bg-white overflow-hidden shadow-sm">
                                            ...
                                            >
                                                ...
                                                <span className="font-bold text-zinc-800 truncate flex-1">
                                            ...
                                            {isExpanded && (
                                                <div className="border-t border-zinc-100 p-3 space-y-3 bg-zinc-50/50">
                                                    {!inv.supplier_id && (
                                                        <div className="flex items-center gap-2">
                                                            <label className="text-[10px] font-bold text-zinc-500 uppercase shrink-0">
                                                                Proveedor:
                                                            </label>
                                                            <select
                                                                ...
                                                                onChange={(e) =>
                                                                    setSelectedSupplierPerInvoice((prev) => ({
                                                                        ...prev,
                                                                        [inv.id]: e.target.value ? Number(e.target.value) : undefined,
                                                                    }))
                                                                }
    ...
    return (
        <tr className="border-b border-zinc-100 last:border-0 align-top">
            <td className="py-2 pr-2">
                <span className="text-xs font-medium text-zinc-800 block max-w-[140px] truncate" title={line.original_name}>
                    {line.original_name}
                </span>
            </td>
            ...
            <td className="py-2 pr-2">
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-7 pr-2 py-1 rounded-lg border border-zinc-200 text-xs bg-white"
                    />
                    <select
                        value={ingredientId}
                        onChange={(e) => setIngredientId(e.target.value)}
                        className="mt-1 w-full rounded-lg border border-zinc-200 px-2 py-1 text-xs bg-white max-h-24"
                    >
            ...
            <td className="py-2 pr-2">
                <input
                    ...
                    className="w-full rounded-lg border border-zinc-200 px-2 py-1 text-xs bg-white w-14"
                />
            </td>
            <td className="py-2">
                <button

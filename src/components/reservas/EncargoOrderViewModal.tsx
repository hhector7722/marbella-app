...
import { generateEncargoOrderPdf } from '@/lib/reservas/encargo-pdf-generator'
import { printPdfBlob } from '@/lib/reservas/print-pdf-blob'
...
export function EncargoOrderViewModal({
  ...
  const handlePrint = useCallback(async () => {
    ...
    setPrintBusy(true)
    try {
      const blob = await generateEncargoOrderPdf(
        {

...
/** Bebidas: imagen contenida en marco de altura fija (evita solapamiento en grid 3 cols). */
export const CARTA_PRODUCT_PHOTO_IMG_DRINK_CLASS =
  'pointer-events-none max-h-full max-w-[80%] h-auto w-auto object-contain object-center'

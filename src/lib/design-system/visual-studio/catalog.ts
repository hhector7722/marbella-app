...
export const STUDIO_ELEMENTS: StudioElement[] = [
    ...
    },
    {
        ...
        group: 'fundamentos',
        status: 'CANON CERRADO',
        summary: 'Inter. Título de pantalla = PageScreen 18/900 uppercase. El resto va en caja oración.',
    ...
    },
    {
        ...
        group: 'piezas',
        status: 'CANON CERRADO',
        summary: 'P3 es patrón, no DatePicker. Las celdas de cuadrante no se convierten en componente universal. El cromo es MonthCalendarFrame (Cierres).',
        blueprintNeedle: '| Calendario |',
        sourceFiles: ['src/components/time/MonthCalendarFrame.tsx'],

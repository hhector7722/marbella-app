...
export const STUDIO_ELEMENTS: StudioElement[] = [
    ...
    },
    {
        ...
        group: 'cabeceras',
        status: 'CANON CERRADO',
        summary: 'Alto 36 px. Chrome ≠ Button. Inset espacio.4. Contrato cerrado. No editable directamente.',
        ...
        applyKind: 'locked',
        facts: [
            { label: 'Altura', value: '36 px · estructura.cabecera-modal' },
            ...
            { label: 'Título', value: 'Misma fila que el subtítulo. La cabecera no crece por encima de 36 px.' },
        ],
        properties: [
    ...
    },
    {
        ...
        group: 'piezas',
        status: 'BORRADOR / PROPUESTA',
        summary: 'Receta de Albaranes. No es Field. No se fabrica Search.tsx hasta cerrar el patrón.',
        blueprintNeedle: '| Search |',
        sourceFiles: [],
        impactPatterns: ['type="search"', "type={'search'}", 'placeholder="Buscar'],
        applyKind: 'blueprint-only',
        properties: [
    ...
    },
    {
        ...
        group: 'piezas',
        status: 'BORRADOR / PROPUESTA',
        summary: 'Candidato: caja de Waste. No se fabrica componente hasta el segundo uso idéntico.',
        blueprintNeedle: '| QuantityStepper |',
        sourceFiles: ['src/app/dashboard/inventory/waste/WasteClient.tsx'],
        impactPatterns: ['WasteClient'],
        applyKind: 'blueprint-only',
        properties: [

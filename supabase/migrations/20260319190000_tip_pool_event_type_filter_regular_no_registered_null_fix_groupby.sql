-- ==============================================================================
-- tip_pool_event_type_filter_regular_no_registered_null_fix_groupby
-- Arregla error 42803 (GROUP BY) en el CTE *remaining_cents*:
-- "column pv.weekday_cash_total must appear in the GROUP BY clause..."
--
-- Solución: usar subselect escalar en lugar de CROSS JOIN pv dentro del CTE
-- que contiene SUM(...).
-- ==============================================================================

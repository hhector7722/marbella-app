-- Fix: dos sobrecargas de auto_map_invoice_lines_fuzzy (double precision vs numeric)
-- provocaban "Could not choose the best candidate function" al llamar la RPC desde Supabase.
-- CREATE OR REPLACE no elimina la firma antigua si cambia el tipo del 2º parámetro.

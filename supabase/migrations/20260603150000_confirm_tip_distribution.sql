-- ==============================================================================
-- confirm_tip_distribution: persiste preview de propinas en historial confirmado
-- ==============================================================================
...
COMMENT ON FUNCTION public.confirm_tip_distribution(date, date, text) IS
    'Confirma el reparto de propinas del periodo: snapshot desde get_tip_pool_preview en tip_distribution_history/lines. Solo manager/admin.';

-- ==============================================================================
-- get_tip_pool_preview: nueva escala de tramos TJI (penalizacion_pct)
-- Hereda 20260604130000 (shadow, sanciones, chef, Largest Remainder, JSON)
-- ==============================================================================
    ...
    hours_with_tji AS (
        SELECT
            ...
            CASE
                ...
                WHEN m.tji_pct <= 5 THEN 5
                WHEN m.tji_pct <= 10 THEN 10
                WHEN m.tji_pct <= 15 THEN 15
                WHEN m.tji_pct <= 20 THEN 20
                WHEN m.tji_pct <= 25 THEN 25
                WHEN m.tji_pct <= 30 THEN 30
                WHEN m.tji_pct <= 40 THEN 40
                WHEN m.tji_pct <= 50 THEN 50
                WHEN m.tji_pct <= 60 THEN 60

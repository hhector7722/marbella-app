-- ==============================================================================
-- get_tip_pool_preview: penalización TJI sobre importe (horas RAW en reparto)
-- + redistribución del bote de descuentos por horas raw (Largest Remainder)
-- Hereda 20260604000001 / 20260604130000 (sanciones, shadow, chef, JSON)
-- ==============================================================================
    ...
    hours_with_tji AS (
        SELECT
            ...
            CASE
                ...
                WHEN m.tji_pct = 0 THEN 0
                WHEN m.tji_pct <= 5 THEN 10
                WHEN m.tji_pct <= 10 THEN 20
                WHEN m.tji_pct <= 15 THEN 30
                WHEN m.tji_pct <= 20 THEN 40
                WHEN m.tji_pct <= 25 THEN 50
                WHEN m.tji_pct <= 35 THEN 65
                WHEN m.tji_pct <= 50 THEN 80
                WHEN m.tji_pct <= 70 THEN 90
                ELSE 100

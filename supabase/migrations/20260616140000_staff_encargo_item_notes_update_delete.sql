...
-- Notas por línea en pedidos staff + actualizar pedido + borrar encargo (staff+)
...
REVOKE ALL ON FUNCTION public.update_staff_event_order(uuid, jsonb) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.update_staff_event_order(uuid, jsonb) TO authenticated;

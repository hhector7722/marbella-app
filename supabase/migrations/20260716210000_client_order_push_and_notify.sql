-- Pedido cliente: misma campana que reservas (user_notifications) + push vía pg_net.
-- Destinatarios = mismos first_name que fn_notify_reservation_insert (alba/hernan/pere/hector).
